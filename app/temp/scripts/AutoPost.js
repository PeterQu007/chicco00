...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ReadWritePost = __webpack_require__(5);

	var _ReadWritePost2 = _interopRequireDefault(_ReadWritePost);
				...
				chrome.storage.sync.get(['postMenuStatus'], function (status) {
					...
					switch (status.postMenuStatus) {
						...
						case 'copy':
							...
							var readPost = new _ReadWritePost2.default(Mode.read, Debug.logLocal);
						...
						case 'new':
							...
							var writePost = new _ReadWritePost2.default(Mode.write, Debug.logLocal);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //Read the fields of a post , prepare to creat a new post
	...
	var ReadWritePost = function () {
		function ReadWritePost(mode, debug) {
			_classCallCheck(this, ReadWritePost);

			this.debug = debug || Debug.disable;
			this.$$$("^^^Inside ReadWritePost module");

			this.form = (0, _jquery2.default)(sels.form);
			this.CategoryID = (0, _jquery2.default)(sels.CategoryID);
			this.PostingTitle = (0, _jquery2.default)(sels.PostingTitle);
			this.PostalCode = (0, _jquery2.default)(sels.PostalCode);
			this.PostingBody = (0, _jquery2.default)(sels.PostingBody);
			this.Price = (0, _jquery2.default)(sels.Price);
			this.ContactPhone = (0, _jquery2.default)(sels.ContactPhone);
			this.ContactName = (0, _jquery2.default)(sels.ContactName);
			this.Street = (0, _jquery2.default)(sels.Street);
			this.CrossStreet = (0, _jquery2.default)(sels.CrossStreet);
			this.City = (0, _jquery2.default)(sels.City);
			this.Region = (0, _jquery2.default)(sels.Region);
			this.OK4Others = (0, _jquery2.default)(sels.OK4Others);
			this.form2 = (0, _jquery2.default)(sels.form2);
			this.CancelEdit = (0, _jquery2.default)(sels.CanelEdit);
		...
		_createClass(ReadWritePost, [{
			...
			value: function writePost(post) {
				...
				chrome.storage.sync.get(['CategoryID', 'PostingTitle', 'PostalCode', 'PostingBody', 'Price', 'ContactPhone', 'ContactName', 'Street', 'CrossStreet', 'City', 'Region', 'OK4Others'], function (post) {
			...
			value: function goHomePage() {
				...
				chrome.runtime.sendMessage(msg, function (response) {
					...
					if (backupHomeURL) {
						...
						chrome.runtime.sendMessage({ from: 'clsReadWritePost', subject: 'setCgNewPost', cgNewPost: true }, function (response) {
			...
			value: function doNewPost() {
				...
				chrome.runtime.sendMessage({ from: 'clsReadWritePost', subject: 'setCgNewPost', cgNewPost: false }, function (response) {
		...
		return ReadWritePost;
	}();

	exports.default = ReadWritePost;
