...
/***/ (function(module, exports, __webpack_require__) {
	...
	var backupListing = new _Listing2.default(); // keep the reposted listing
	...
	chrome.runtime.onMessage.addListener(function (msg, sender, response) {
	  ...
	  if (msg.from === 'classTable' && msg.subject === 'currentListingUpdated') {
	    ...
	    chrome.tabs.query({
	      ...
	      chrome.tabs.sendMessage(tabs[0].id, { from: 'background', subject: 'currentListingUpdated' }, function () {
